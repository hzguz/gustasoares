...
const GridLines: React.FC<GridLinesProps> = ({ variant = 'full' }) => {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <div 
        className="mx-auto w-[94%] max-w-[1600px] px-6 h-full relative border-x transition-colors duration-500"
        style={{ borderColor: gridColor }}
      >
        {/* Corners of the main box - Replaced with Triangles */}
        {/* Top Left */}
        <CornerTriangle className="-top-[1px] -left-[1px]" />
        {/* Top Right - Flipped Horizontally */}
        <CornerTriangle className="-top-[1px] -right-[1px]" style={{ transform: 'scaleX(-1)' }} />
        {/* Bottom Left - Flipped Vertically */}
        <CornerTriangle className="-bottom-[1px] -left-[1px]" style={{ transform: 'scaleY(-1)' }} />
        {/* Bottom Right - Flipped Both */}
        <CornerTriangle className="-bottom-[1px] -right-[1px]" style={{ transform: 'scale(-1, -1)' }} />
