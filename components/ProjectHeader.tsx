    ...
    <>
      ...
      >
        <div className="w-full max-w-[1800px] mx-auto px-5 md:px-6 lg:px-8">
          {/* Container with blur - matching Home Header style */}
          <div className={`flex items-center justify-between px-6 md:px-8 py-4 backdrop-blur-md border border-black/[0.04] rounded-full transition-all duration-300 ${isScrolled ? 'bg-white/70' : 'bg-white/5'}`}>
